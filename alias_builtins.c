...
/**
 * set_alias - Would either set an existing alias 'name' with a new value,
...
/**
 * replace_aliases - Goes through the arguments
 * & exchange with any matching alias with their value.
